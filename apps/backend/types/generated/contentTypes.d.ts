...
export interface ApiGlobalSettingGlobalSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    cookie_consent_text: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    ga4_measurement_id: Schema.Attribute.String;
    google_ads_id: Schema.Attribute.String;
...
export interface ApiIntakeSubmissionIntakeSubmission
  extends Struct.CollectionTypeSchema {
  collectionName: 'intake_submissions';
  info: {
    displayName: 'Intake Submission';
    pluralName: 'intake-submissions';
    singularName: 'intake-submission';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::intake-submission.intake-submission'
    > &
      Schema.Attribute.Private;
    ...
    service_type: Schema.Attribute.Enumeration<
      ['bedrijfsjuristen', 'trust_formation', 'belastingadvies']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    nav_order: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    show_in_nav: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    slug: Schema.Attribute.UID<'title'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::intake-submission.intake-submission': ApiIntakeSubmissionIntakeSubmission;
